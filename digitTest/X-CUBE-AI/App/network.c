...
#define AI_NETWORK_MODEL_SIGNATURE     "7d9a2645209e2d7d7448b22377688aaf"
...
#define AI_TOOLS_DATE_TIME   "Wed Aug  4 16:00:07 2021"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 1600, 128, 1, 1), AI_STRIDE_INIT(4, 1, 800, 102400, 102400),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    dense_output_array.data = AI_PTR(activations_map[0] + 6400);
    dense_output_array.data_start = AI_PTR(activations_map[0] + 6400);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    dense_bias_array.data = AI_PTR(weights_map[0] + 177728);
    dense_bias_array.data_start = AI_PTR(weights_map[0] + 177728);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights_map[0] + 178240);
    dense_1_weights_array.data_start = AI_PTR(weights_map[0] + 178240);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights_map[0] + 183360);
    dense_1_bias_array.data_start = AI_PTR(weights_map[0] + 183360);
    return true;
  }
  return false;
}
